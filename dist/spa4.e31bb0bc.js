...
},{"lit-html/lib/shady-render.js":"../../node_modules/lit-html/lib/shady-render.js","./lib/updating-element.js":"../../node_modules/lit-element/lib/updating-element.js","./lib/decorators.js":"../../node_modules/lit-element/lib/decorators.js","lit-html/lit-html.js":"../../node_modules/lit-html/lit-html.js","./lib/css-tag.js":"../../node_modules/lit-element/lib/css-tag.js"}],"node_modules/simple-wc-router/dist/index.m.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Router = exports.RouteMixin = void 0;

const t = t => t.includes("/") ? "/" === t.charAt(0) ? t.substring(1).split("/") : t.split("/") : [t],
      e = document.createElement.bind(document),
      o = history.pushState.bind(history),
      n = history.replaceState.bind(history),
      s = window.removeEventListener.bind(window),
      i = window.dispatchEvent.bind(window),
      r = window.addEventListener.bind(window),
      u = {
  Router: {
    NoRoutes: "Router :: No routes were defined!"
  },
  RouteMixin: {
    NoRoute: "RouteMixin :: `navigate` method requires the ### component to have a route property/attribute"
  }
},
  ...
  constructor() {
    super();
    const t = a();
    this.routeProps = {}, this.lastRoute = null, n({
      route: t
    }, null, t);
  }

  connectedCallback() {
    super.connectedCallback(), r("popstate", this.__handleNav.bind(this)), i(new PopStateEvent("popstate", {
      state: {
        route: a()
      }
    }));
  ...
  disconnectedCallback() {
    super.disconnectedCallback(), s("popstate", this.__handleNav.bind(this));
  }

  __handleNav(e) {
    if (!this.constructor.routes) throw u.Router.NoRoutes;

    const o = e.state.route,
          n = ((e, o) => {
      const n = e.find(({
        path: t
      }) => t === o);
      ...
      const s = e.find(t => "*" === t.path),
        ...
        const n = o.filter(t => !t.includes(":?")).length;
        return !(o[0].includes(":") || i.length < n || i.length > o.length) && o.every((t, e) => o[e].includes(":?") ? (r[o[e].replace(":?", "")] = i[e], !0) : o[e].includes(":") ? (r[o[e].replace(":", "")] = i[e], !0) : t === i[e]);
      });
      return !u && s ? {
        route: s
      } : u || s ? {
    ...
    })(this.constructor.routes, o);

    n && (this.route = n.route, this.routeProps = n.props), this.lastRoute !== o && (this.setRouteElement(), this.lastRoute = o);
  }

  setRouteElement() {
    const t = () => {
      let t;
      "function" == typeof this.route.render ? t = this.route.render(this.routeProps) : (t = e(this.route.component), Object.assign(t, this.routeProps)), this.routeElement = t;
    };

    this.route ? customElements.get(this.route.component) || "function" != typeof this.route.import ? t() : this.route.import().then(t) : this.routeElement = null;
  }
  ...
  connectedCallback() {
    super.connectedCallback(), this.isRouteActive = this.route === window.location.pathname, r("popstate", this.__handleActive.bind(this));
  }

  disconnectedCallback() {
    super.disconnectedCallback(), s("popstate", this.__handleActive.bind(this));
  }

  __handleActive(t) {
    this.isRouteActive = t.state.route === this.route;
  }

  navigate(t) {
    const e = t || this.route;
    if (!e) throw u.RouteMixin.NoRoute.replace("###", this.nodeName);
    if (e === window.location.pathname) return;
    if ("/" !== e.substring(0, 1)) return void (window.location.href = e);
    const n = {
      route: e
    };
    o(n, null, e), i(new PopStateEvent("popstate", {
      state: n
    }));
  }
...
exports.RouteMixin = l;
exports.Router = c;
},{}],"pages/page_home.js":[function(require,module,exports) {

},{}],"components/navli.js":[function(require,module,exports) {
"use strict";

var _litElement = require("lit-element");

var _simpleWcRouter = require("simple-wc-router");
...
var Navli = /*#__PURE__*/function (_RouteMixin) {
  _inherits(Navli, _RouteMixin);

  var _super = _createSuper(Navli);
  ...
  _createClass(Navli, [{
    ...
    value: function render() {
      var activeClass = this.isRouteActive ? 'active' : '';
      var clickHandler = this.handleClick.bind(this);
      return (0, _litElement.html)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n            <li class=\"nav-item\">\n                <a href=\"#\" class=\"nav-link ", "\" @click=\"", "\">", "</a>\n            </li>\n        "])), activeClass, clickHandler, this.linkText);
    }
  }, {
  ...
  return Navli;
}((0, _simpleWcRouter.RouteMixin)(_litElement.LitElement));

customElements.define('w-nav', Navli);
},{"lit-element":"../../node_modules/lit-element/lit-element.js","simple-wc-router":"node_modules/simple-wc-router/dist/index.m.js"}],"../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/bundle-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var App = /*#__PURE__*/function (_Router) {
    ...
    get: function get() {
      ...
      }, // Using 'type' and 'day' variable.
      {
        ...
        import: function _import() {
          return require("_bundle_loader")(require.resolve("./pages/first-page.js"));
        }
      }, // Fallback for all unmatched routes.  
      {
        path: "*",
        render: function render() {
          return (0, _litElement.html)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<h2>404 The requested page could not be found</h2>"])));
        }
      }];
    }
  }]);
  ...
  return App;
}((0, _simpleWcRouter.Router)(_litElement.LitElement));

customElements.define('my-app', App);
},{"lit-element":"../../node_modules/lit-element/lit-element.js","simple-wc-router":"node_modules/simple-wc-router/dist/index.m.js","./pages/page_home.js":"pages/page_home.js","./components/navli.js":"components/navli.js","_bundle_loader":"../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/bundle-loader.js","./pages/first-page.js":[["first-page.0e70a1d5.js","pages/first-page.js"],"first-page.0e70a1d5.js.map","pages/first-page.js"]}],"../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}],"../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js":[function(require,module,exports) {
...
var b=require("../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));
},{}]},{},["../../.nvm/versions/node/v14.16.0/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0,"index.js"], null)
//# sourceMappingURL=/spa4.e31bb0bc.js.map